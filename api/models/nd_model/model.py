...
class kerasND:
    ...
    def create_keras_model(self, data):
        self.data = data
        ...
        # initialize weights
        keras_model = kerasND.initialize_weights(
            keras_model, self.n_data, self.units)

        # assign to class
        self.keras_model = keras_model
        y, self.max_min_list= kerasND.scale_data(self.data, self.units)
    ...
    def predict(self):
        ...
        self.predictions = kerasND.inverse_scale_data(
    ...
    def get_cycles(self):
        ...
        # assign to class
        self.cycles = kerasND.inverse_scale_data(
    ...
    def get_trend(self):
        ...
        # assign to class
        self.trend = kerasND.inverse_scale_data(
